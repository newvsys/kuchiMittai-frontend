...
const DashboardProductDetails = ({ params }: DashboardProductDetailsProps) => {
  ...
  const deleteProduct = async () => {
    ...
    apiClient
      ...
      .catch((error) => {
        showError("There was an error while deleting product");
      });
  };
  ...
  const updateProduct = async () => {
    if (
      ...
      showError("You need to enter values in input fields");
      return;
    }
    ...
    try {
      ...
      showError("There was an error while updating product");
    }
  };
  ...
  const uploadFile = async (file: any) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        showError("File upload unsuccessful.");
      }
    } catch (error) {
      console.error("There was an error while during request sending:", error);
      showError("There was an error during request sending");
    }
  };
