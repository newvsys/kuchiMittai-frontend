...
const CheckoutPage = () => {
  ...
  useEffect(() => {
    ...
    if (filterQuery) setContinueShoppingHref(`/search?${filterQuery}`);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-screen-2xl mx-auto overflow-x-hidden px-4 sm:px-6 lg:px-8 py-6">
        {/* Breadcrumb */}
        <nav className="mb-6 flex items-center justify-between gap-2 text-sm font-medium">
          ...
          <a href={continueShoppingHref} className="flex items-center gap-1 text-blue-600 hover:text-blue-800 transition-colors">
            Continue Shopping
