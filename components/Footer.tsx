    ...
    <footer className="bg-gray-800 text-gray-300" aria-labelledby="footer-heading">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-7 text-gray-400">
              At trynat, we bring the authentic taste of tradition right to your doorstep. We specialize in delivering a wide range of premium delicacies, including traditional sweets, crispy snacks, quality cooking oils, and many more.
            </p>
      ...
      <div className="border-t border-gray-700">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-center gap-2 text-xs text-gray-500">
          <span>&copy; 2026 trynat India Pvt Ltd. All rights reserved.</span>
          <span>
            Powered by{" "}
